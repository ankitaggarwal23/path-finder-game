...
void frontscreen(void)
{
	...
	glColor3f(1,0,0);
	output(70,40,"Ms.Sharon Roji Priya,Dept. of CSE");
	glColor3f(1,0,0);
	output(40,30,"");
	glColor3f(1,0,0);
...
int main(int argc,char **argv)
{
    ...
    glutCreateWindow("Path Finder Game");
